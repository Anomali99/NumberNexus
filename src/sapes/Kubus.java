...
public class Kubus extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("0");
        pn_ilustrasi.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 450, 200, -1));

        jLabel4.setText("0");
        pn_ilustrasi.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 450, 200, -1));

        jLabel5.setText("Sisi =");
        pn_ilustrasi.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 450, -1, -1));

        jLabel2.setText("Sisi =");
        pn_ilustrasi.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 430, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/kubus.png"))); // NOI18N
        pn_ilustrasi.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 40, -1, -1));

        jLabel6.setText("Sisi =");
        pn_ilustrasi.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 240, -1, -1));

        jLabel7.setText("0");
        pn_ilustrasi.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 260, 40, -1));
